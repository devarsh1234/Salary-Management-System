...
class splash{
    public static void main(String s[]){
        //scalable frame = sframe 
        sframe f1 = new sframe("Salary Management System (Think and Build)"); 
...
class sframe extends JFrame implements Runnable{
    ...
    sframe(String s){
        ...
        ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("pictures/splash.png"));
